...
var Cex = /** @class */ (function (_super) {
    __extends(Cex, _super);
    function Cex(restApiBaseUrl, wsBaseUrl) {
        var _this = _super.call(this, restApiBaseUrl, wsBaseUrl) || this;
        _this.channelSymbolMap = {};
        return _this;
    }
    Cex.prototype.populateSymbols = function () {
    ...
    Cex.prototype.subscribe = function () {
        var self = this;
    ...
    Cex.prototype.listen = function () {
        ...
        self.webSocket.onmessage = function (msg) {
            try {
                ...
                //let ticker = new TickerModel('Cex', symbol, data.price, new Date());
    ...
    Cex.prototype.extractTickerFromResponse = function (response) {
